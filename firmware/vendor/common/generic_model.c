...
int rdDeleteNode(u8 *par, int par_len, mesh_cb_fun_par_t *cb_par);
...
const mesh_cmd_sig_func_t mesh_cmd_sig_func[] = {
	...
	{NODE_RESET, 0, SIG_MD_CFG_CLIENT, SIG_MD_CFG_SERVER,rdDeleteNode,NODE_RESET_STATUS},
...
//RD_EDIT: disable LIGHTNESS_GET message
...
int rdDeleteNode(u8 *par, int par_len, mesh_cb_fun_par_t *cb_par){
	 mesh_cmd_sig_cfg_node_reset(par,par_len,cb_par);
	 deleteNode = 1;
	 //rdPrintf("xoa")
	 return 0;
}
