...
_USER_CAN_REDEFINE_ void mesh_scan_rsp_init()
{
		...
		/*RD_EDIT: 31/05/2022
		 * sua theo y kien cua anh hung
		 *
		 * */
		tbl_scanRsp.rsv_user[0] = 0x03;
		tbl_scanRsp.rsv_user[1] = 0x02;
		tbl_scanRsp.rsv_user[2] = 0x01;

		tbl_scanRsp.rsv_user[3] = 0x00;
		tbl_scanRsp.rsv_user[4] = 0x00;
		tbl_scanRsp.rsv_user[5] = 0x00;

		tbl_scanRsp.rsv_user[6] = 0x01;  //version
		tbl_scanRsp.rsv_user[7] = 0x08;	//version

		tbl_scanRsp.rsv_user[8] = 0x00;
		tbl_scanRsp.rsv_user[9] = 0x00;
		tbl_scanRsp.rsv_user[10] = 0x00;
		for(unsigned char i=0;i<11;i++) broadcast[i] = tbl_scanRsp.rsv_user[i];
